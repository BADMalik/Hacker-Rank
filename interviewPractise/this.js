...
// obj2.arrowFn.call(this); // Outputs: a in obj2
...
//---- THIS SHOWS IMPORTANT NOTION OF HOW FUNC ABD => CAN DIFFER
...
function createObject() {
  ...
  return {
    ...
    foobar: () => console.log("Inside `bar`:", this.foo),
  };
}
let foo = 1221;
createObject.call({ foo: 21 }).bar();

createObject.call({ foo: 21 }).foobar();
